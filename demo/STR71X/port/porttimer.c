  ...
  *
  * File: $Id: porttimer.c,v 1.4 2006/02/26 19:26:08 wolti Exp $
  */
...
static USHORT   usTimerDeltaOCRB;
...
vMBPortTimersEnable(  )
{
    ...
    if( usTimerDeltaOCRB > 0 )
    {
        MB_TIMER_DEV->OCBR = usTimerDeltaOCRB;
        maskTimFlags |= TIM_OCFB;
        maskTimIT |= TIM_OCB_IT;
    }
